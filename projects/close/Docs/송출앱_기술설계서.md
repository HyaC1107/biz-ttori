...
| 항목 | 내용 |
| :--- | :--- |
| iOS SDK | **AmazonIVSBroadcast** v1.43.0 (2026-06-04 업데이트) — CocoaPods 배포 중단에 대응하여, **XCFramework 직접 링킹 및 Local Podspec 선언적 자동화** 방식으로 아키텍처 확정 |
| Android SDK | **Amazon IVS Broadcast SDK for Android** (`com.amazonaws:ivs-broadcast`) v1.43.0 (2026-06-04) — Maven/Gradle 공식 지원 |
