# 🏢 Biz-Ttori — 회사 업무 및 풀스택 개발 오케스트레이터

이 저장소는 React Native, React, Fullstack 개발 업무와 기획, 사내 문서 작성, 그리고 Slack 연동을 자동화하고 관리하기 위한 **AI 에이전트 협업 워크스페이스**입니다.
...
│    ├── api-specs.md      ← FE↔BE 계약 단일 통로 SSOT (G3) ★G-Brain
│    ├── g-brain-map.md    ← 지식 관계 인덱스 (지식 그래프 지도) ★G-Brain
│    ├── stack.md          ← 풀스택/RN 개발 트러블슈팅 및 가이드
